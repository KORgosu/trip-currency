...
│   │   ├── kafka/
│   │   │   ├── serviceaccounts.yaml       # sa-kafka, sa-zookeeper, sa-kafka-ui
...
│               ├── 08-kafka-ui.yaml
│               ├── 09-zookeeper.yaml
│               └── 10-allow-prometheus-scrape.yaml  # monitoring ns → :8000/:8080
│
├── aws/                                   # AWS CLI 입력 파일
│   ├── eks/
...
| 10-allow-prometheus-scrape.yaml | monitoring ns → 모든 Pod :8000/:8080 |
